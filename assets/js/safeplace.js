...
return fetch('https://test.api.amadeus.com/v1/security/oauth2/token', {
  ...
  .then((data) => {
    ...
    const amadeusEndpoint = `https://test.api.amadeus.com/v2/safety/safety-rated-locations?originLocationCode=${currentIataCode}&destinationLocationCode=${destinationIataCode}&departureDate=${departureDate}&adults=1&nonStop=true&currencyCode=USD&max=250`;
